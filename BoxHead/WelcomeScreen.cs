...
class WelcomeScreen : Screen
{
    ...
    public override void Show()
    {
        ...
        do
        {
            ...
            hardware.DrawSprite(imgTitle, 280, (short)(GameController.SCREEN_HEIGHT-contText), 0, 0
                , GameController.SCREEN_WIDTH,
                GameController.SCREEN_HEIGHT);
            hardware.WriteText("Press any key to continue",(GameController.SCREEN_WIDTH/2)-150,contText,170,0,0,fontTitle);
